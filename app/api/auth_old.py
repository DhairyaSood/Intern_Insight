...
def login():
    ...
    try:
        ...
        # Get candidate_id from user document
        candidate_id = str(user.get('_id', '')) if user else None
        ...
        if logged_in and username:
            ...
            if db is not None:
                try:
                    ...
                    app_logger.warning(f"Failed to get candidate_id: {e}")
